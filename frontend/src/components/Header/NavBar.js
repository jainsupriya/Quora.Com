...
class NavBar extends React.Component {
  ...
  render() {
        ...
        <div>
            ...
            >
                ...
                <Tabs
                    ...
                    textColor="primary"
                >
                    <Tab label="Question" icon={<ThumbDown />} />
                    <Tab label="Link" icon={<ThumbUp />} />
                </Tabs>
    ...
    return (
      <div>
          {modal}
          <AppBar className="m-bg-color" position="static">
          <Grid
              container
              direction="row"
              justify="center"
              ...
              <Grid item xs={8}>
                  <Grid
                      ...
                      <image className="logo-img" ></image>
                        
                            <div className="menu-clr-1">
                                <button style={{background:"none", border:"none", outline:"none"}} onClick={() => (this.handleClickNav("home"))}>
                            ...
                            <div className="menu-clr-2">
                                <button style={{background:"none", border:"none", outline:"none"}} onClick={() => (this.handleClickNav("spaces"))}>
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                                    <g stroke="none" class="icon_svg-fill_as_stroke" fill="#666" fill-rule="nonzero">
                            ...
                            <div className="menu-clr-2">
                                <button style={{background:"none", border:"none", outline:"none"}} onClick={() => (this.handleClickNav("notifications"))}>
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                    <g stroke="none" class="icon_svg-fill_as_stroke" fill="#666" fill-rule="nonzero">
                      ...
                      <input className="header-search" placeholder="Search Quora" autofocus="True" type="text">

                      </input>
                      <Avatar alt="Remy Sharp" src="1.jpg" className="avatar" />
                      <button className="askQuestionBtn" onClick={this.handleOnAddQclick}>Add Question or Link</button>
                  </Grid>
              </Grid>
              <Grid item xs={2}>
              </Grid>
