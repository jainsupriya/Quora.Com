      ...
      >
          ...
          <Grid item xs={8}>
              ...
              >
                  ...
                  <div className={this.state.navSelectedItem === "home" ? "menu-clr-1" : "menu-clr-2"}  onClick={()=>{this.navigationClick("home")}}>
                      <svg
                          width="24px"
                          height="24px"
                          viewBox="0 0 24 24"
                      ...
                      >
                          <g
                              ...
                              fill={this.state.navSelectedItem === "home" ? "#b92b27" : "#666"}
                              fillRule="nonzero"
                          >
                  ...
                  <div className={this.state.navSelectedItem === "answer" ? "menu-clr-1" : "menu-clr-2"} onClick={()=>{this.navigationClick("answer")}}>
                      <svg
                          width="24px"
                          height="24px"
                          viewBox="0 0 24 24"
                      ...
                      >
                          <g
                              stroke="none"
                              className="icon_svg-fill_as_stroke"
                              fill={this.state.navSelectedItem === "answer" ? "#b92b27" : "#666"}
                              fillRule="nonzero"
                          >
                  ...
                  <div className={this.state.navSelectedItem === "spaces" ? "menu-clr-1" : "menu-clr-2"}  onClick={()=>{this.navigationClick("spaces")}}>
                      <svg
                          width="24px"
                          height="24px"
                          viewBox="0 0 24 24"
                      ...
                      >
                          <g
                              stroke="none"
                              className="icon_svg-fill_as_stroke"
                              fill={this.state.navSelectedItem === "spaces" ? "#b92b27" : "#666"}
                              fillRule="nonzero"
                          >
                  ...
                  <div className={this.state.navSelectedItem === "notifications" ? "menu-clr-1" : "menu-clr-2"}  onClick={this.handleNotification}>
                      ...
                      >
                          <g
                              stroke="none"
                              className="icon_svg-fill_as_stroke"
                              fill={this.state.navSelectedItem === "notifications" ? "#b92b27" : "#666"}
                              fillRule="nonzero"
                          >
